(function(){
	...
	jQuery.topmsg=function(msg,sleep,param,animate){
		...
		'}@media (max-width: 600px) {#sl_topmsg_body{width:90%}}@media (min-width: 600px) {#sl_topmsg_body{width:500px}}'+
                '.spinner {width: 60px;height: 60px;background-color:#e63d4f;margin: 50px auto;-webkit-animation: rotateplane 1.2s infinite ease-in-out;animation: rotateplane 1.2s infinite ease-in-out;}'+
