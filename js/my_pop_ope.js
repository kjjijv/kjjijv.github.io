	...
	my_pop_ope.prototype.pop_wrap=function (param){
		...
		var tpl=''+
			'<style class="js_mypop_allbox js_mypop_allbox_css">'+
				...
				'#my-form-sub-wrap{margin:100px auto;padding:0px;color: #333;background-color: #fff;color: #333;border-radius: 5px;box-shadow: 0 0 4px rgba(0, 0, 0, 0.55), 0 4px 8px rgba(0, 0, 0, 0.28);}'+
				'.myformcontent{padding: 25px '+(wt<500?'0':'25px')+';padding: 25px '+(wt<500?'0':'25px')+';}'+
				'.myformtitle{background-color:'+param.color+';border-top-left-radius:'+param.bdrd+';border-top-right-radius:'+param.bdrd+';color:#fff}'+
				...
				'#my-form-sub-box .myopehide{display:none;}'+
                                ...
                                '@media (min-width: 700px){.myformtitle{padding:15px;}}'+
				...
				'.js-my-repalce-cancel svg:hover{color:'+param.color+'}'+
                                '.my-steoptdiv{margin-top:10px;border-radius: 5px;width: 100%;border: 1px solid #999;padding: 15px;cursor:pointer}'+
                                '.my-opt_intro{margin-top:10px;border-radius: 5px;width: 100%;border: 1px solid #999;padding: 15px;}'+
				...
				'#my-form-sub-box .popimgbox img{max-width:98%;max-height:55px;}'+
                                '#my-form-sub-box .introsaid{padding:15px;background-color:#eee;}'+
			...
			'<div id="my-form-sub-box" class="my-form-sub-box js_mypop_allbox my-said-replace-box my-parents-box" style="z-index:'+param.zindex+'">'+
					'<div id="my-form-sub-wrap" class="my-form-pbox">'+
						'<div class="my-form-replace-wrap">'+
							'<div class="tit-my-replace myformtitle">'+
								...
								'<div title="点击关闭"    style="float:right;cursor: pointer;" class="fright js-my-repalce-cancel my-not-act js-my-common-close">'+
									'<svg fill="#fff" t="1585449871160" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2204" width="20" height="20"><path d="M959.488 964.608c-22.528 22.528-58.88 22.528-81.408 0L56.32 142.336c-22.528-22.528-22.528-58.88 0-81.408s58.88-22.528 81.408 0l822.272 822.272c22.016 22.528 22.016 58.88-0.512 81.408z" p-id="2205"></path><path d="M959.488 60.928c22.528 22.528 22.528 58.88 0 81.408L137.728 964.608c-22.528 22.528-58.88 22.528-81.408 0s-22.528-58.88 0-81.408L878.592 60.928c22.016-22.016 58.88-22.016 80.896 0z" p-id="2206"></path></svg>'+
								'</div>'+
		...
		if(param.wrap!=undefined){
			...
			$('#my-form-sub-box').find('#my-form-sub-wrap').css('border','1px solid #ececec');
	...
	my_pop_ope.prototype.create_form=function (aft,param){
		...
		for(var key in aft){
			...
			if(obj.type=='intro'||obj.type=='desp'){
				...
				if(obj.title!=undefined){
					content+='	<div style="font-size:18px;font-weight:600;">'+(obj.title==undefined?'':obj.title)+'</div>';
				}
                                if(obj.desp!=undefined){
					content+='	<div style="font-size:14px;margin-top:10px">'+(obj.desp==undefined?'':obj.desp)+'</div>';
				}
				content+='<div style="clear:both"></div></div>';
			}
